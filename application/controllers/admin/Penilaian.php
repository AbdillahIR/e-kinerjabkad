...

{
    ...
    public function penilaian_pegawai($id)
    {
        ...
        // loop untuk mengelompokan data berdasarkan 'kode' dan 'nama_kriteria'
        foreach ($result as $row) {
            ...
            // tambahkan keterangan ke dalam array keterangan untuk kateogri tersebut
    ...
    public function detail($id_pegawai)
    {
        ...
        foreach ($data_nilai as $row) {
            ...
            // jika kategori belum di array, tambahkan
            if (!isset($grouped_data[$kode])) {
                $grouped_data[$kode] = [
                    'kode' => $kode,
                    'nama_kriteria' => $nama_kriteria,
    ...
    public function print($id_pegawai)
    {
        ...
        $this->load->view("admin/blanko_print_penilaian", $data);
    }
}
