<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?= base_url('edit-jabatan/' . $jabatan['id']) ?>" method="post">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="kode_jabatan" class="label-control">Kode Jabatan</label>
                            <input value="<?php echo $jabatan['kode']; ?>" name="kode_jabatan" id="kode_jabatan" type="text" class="form-control">
                        ...
                        <div class="mb-3">
                            ...
                            <input value="<?php echo $jabatan['nama_jabatan']; ?>" name="nama_jabatan" id="nama_jabatan" type="text" class="form-control">
