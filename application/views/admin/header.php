...
<head>
    ...
    <script src="https://kit.fontawesome.com/df94ae0165.js" crossorigin="anonymous"></script>
    <link
        href="<?php echo base_url('assets/admin/') ?>vendor/fontawesome-free/css/all.min.css"
        rel="stylesheet"
        type="text/css" />
    <link
        ...
        <ul
            ...
            <a
                ...
                <div class="sidebar-brand-icon ">
                    ...
                    <img width="50" src="<?= base_url('assets/img/logobkad.png') ?>" alt="">
                </div>
                <div class="sidebar-brand-text mx-3">E-Kinerja BKAD</div>
            </a>
            ...
            ?>
            <li class="nav-item <?= $page == 'lpj' ? 'active' : ''; ?>">
            ...
            <!-- <li class="nav-item">
                ...
                <div
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item <?= $page == 'lpj' ? 'active' : ''; ?>" href="<?= base_url('lpj') ?>">Upload LPJ</a>
                        <a class="collapse-item <?= $page == 'dokumentasi' ? 'active' : ''; ?>" href="<?= base_url('dokumentasi') ?>">Dokumentasi</a>
                    </div>
                </div>
            </li> -->
