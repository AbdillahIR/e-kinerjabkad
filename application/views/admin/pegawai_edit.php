                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input value="<?php echo $pegawai['nama']; ?>" name="nama_lengkap" id="nama_lengkap" type="text" class="form-control">
                        ...
                        <div class="mb-3">
                            ...
                            <input value="<?php echo $pegawai['nip']; ?>" name="nip" id="nip" type="text" class="form-control">
                        ...
                        <div class="mb-3">
                            ...
                            <input value="<?php echo $pegawai['tmp_lahir']; ?>" name="tmp_lahir" id="tmp_lahir" type="text" class="form-control">
                        ...
                        <div class="mb-3">
                            ...
                            <input value="<?php echo $pegawai['tgl_lahir']; ?>" name="tgl_lahir" id="tgl_lahir" type="date" class="form-control">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="email" id="email" type="email" class="form-control <?= form_error('email') ? 'is-invalid' : ''; ?>" id="email" value="<?php echo $pegawai['email']; ?>">
                            <div class="invalid-feedback">
                                <?= form_error('email')  ?>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <input name="no_tlp" id="no_tlp" type="text" class="form-control <?= form_error('no_tlp') ? 'is-invalid' : ''; ?>" id="no_tlp" value="<?php echo $pegawai['no_tlp']; ?>">
                            <?php
